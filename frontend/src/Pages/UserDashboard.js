...
import { getTicketsByUserId } from "../Slices/TicketSlice";
...
const UsersDashboard = () => {
  ...
  const totalTicktes = tickets.length;
          ...
          <MDBCol lg="8">
            ...
            <MDBRow>
              ...
              <MDBCol md="6">
                <MDBCard className="mb-4 mb-md-0">
                  <MDBCardBody>
                    <MDBCardText className="mb-4">Total Task</MDBCardText>
                    <MDBCardText className="mb-1" style={{ fontSize: '20px' }}><strong>{totalTicktes}</strong></MDBCardText>
